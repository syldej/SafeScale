...
func (w ErrorTraceProvider) Build(something map[string]interface{}) (_ Provider, err error) {
	defer func() {
		if err != nil {
...
func (w ErrorTraceProvider) ListImages(all bool) (_ []resources.Image, err error) {
	defer func() {
		if err != nil {
			logrus.Tracef("Intercepted error: %+v", err)
		}
...
func (w ErrorTraceProvider) ListTemplates(all bool) (_ []resources.HostTemplate, err error) {
	defer func() {
		if err != nil {
			logrus.Tracef("Intercepted error: %+v", err)
		}
...
func (w ErrorTraceProvider) GetAuthenticationOptions() (_ providers.Config, err error) {
	defer func() {
		if err != nil {
			logrus.Tracef("Intercepted error: %+v", err)
		}
...
func (w ErrorTraceProvider) GetConfigurationOptions() (_ providers.Config, err error) {
	defer func() {
		if err != nil {
			logrus.Tracef("Intercepted error: %+v", err)
		}
...
func (w ErrorTraceProvider) ListAvailabilityZones() (_ map[string]bool, err error) {
	defer func() {
		if err != nil {
			logrus.Tracef("Intercepted error: %+v", err)
		}
...
// ListRegions ...
func (w ErrorTraceProvider) ListRegions() (_ []string, err error) {
	defer func() {
		if err != nil {
			logrus.Tracef("Intercepted error: %+v", err)
		}
...
// GetImage ...
func (w ErrorTraceProvider) GetImage(id string) (_ *resources.Image, err error) {
	defer func() {
		if err != nil {
			logrus.Tracef("Intercepted error: %+v", err)
		}
...
// GetTemplate ...
func (w ErrorTraceProvider) GetTemplate(id string) (_ *resources.HostTemplate, err error) {
	defer func() {
		if err != nil {
			logrus.Tracef("Intercepted error: %+v", err)
		}
...
// CreateKeyPair ...
func (w ErrorTraceProvider) CreateKeyPair(name string) (_ *resources.KeyPair, err error) {
	defer func() {
		if err != nil {
			logrus.Tracef("Intercepted error: %+v", err)
		}
...
// GetKeyPair ...
func (w ErrorTraceProvider) GetKeyPair(id string) (_ *resources.KeyPair, err error) {
	defer func() {
		if err != nil {
			logrus.Tracef("Intercepted error: %+v", err)
		}
...
// ListKeyPairs ...
func (w ErrorTraceProvider) ListKeyPairs() (_ []resources.KeyPair, err error) {
	defer func() {
		if err != nil {
			logrus.Tracef("Intercepted error: %+v", err)
		}
...
// CreateNetwork ...
func (w ErrorTraceProvider) CreateNetwork(req resources.NetworkRequest) (_ *resources.Network, err error) {
	defer func() {
		if err != nil {
			logrus.Warnf("Intercepted error: %+v", err)
		}
	}()
...
// GetNetwork ...
func (w ErrorTraceProvider) GetNetwork(id string) (_ *resources.Network, err error) {
	defer func() {
		if err != nil {
			logrus.Tracef("Intercepted error: %+v", err)
		}
...
// GetNetworkByName ...
func (w ErrorTraceProvider) GetNetworkByName(name string) (_ *resources.Network, err error) {
	defer func() {
		if err != nil {
			logrus.Tracef("Intercepted error: %+v", err)
		}
...
// ListNetworks ...
func (w ErrorTraceProvider) ListNetworks() (_ []*resources.Network, err error) {
	defer func() {
		if err != nil {
			logrus.Tracef("Intercepted error: %+v", err)
		}
...
// CreateGateway ...
func (w ErrorTraceProvider) CreateGateway(req resources.GatewayRequest) (_ *resources.Host, _ *userdata.Content, err error) {
	defer func() {
		if err != nil {
			logrus.Tracef("Intercepted error: %+v", err)
		}
...
// WaitHostReady
func (w ErrorTraceProvider) WaitHostReady(hostParam interface{}, timeout time.Duration) (_ *resources.Host, err error) {
	defer func() {
		if err != nil {
			logrus.Tracef("Intercepted error: %+v", err)
		}
