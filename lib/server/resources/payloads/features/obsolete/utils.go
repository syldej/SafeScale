...
func UploadFile(localpath string, host *protocol.Host, remotepath, owner, group, rights string) (err error) {
	if localpath == "" {
...
// func UploadStringToRemoteFile(content string, host *protocol.Host, filename string, owner, group, rights string) error {
// 	if content == "" {
...
func gatewayFromHost(host *protocol.Host) *protocol.Host {
