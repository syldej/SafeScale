...
import (
	...
	"github.com/CS-SI/SafeScale/lib/server/install/engine/enums/Method"
...
// NewHostTarget ...
func NewHostTarget(host *pb.Host) (install.Targetable, error) {
	if host == nil {
...
// ClusterTarget defines a target of type Host, satisfying install.Targetable
...
// NewClusterTarget ...
func NewClusterTarget(task concurrency.Task, cluster cluster.Cluster) (install.Targetable, error) {
	if cluster == nil {
...
// NewNodeTarget ...
func NewNodeTarget(host *pb.Host) (install.Targetable, error) {
	if host == nil {
		return nil, scerr.InvalidParameterError("host", "cannot be nil")
	}
